        ...
        <section className="bg-gradient-to-r from-accent to-accent/80 text-white py-20">
          <div className="container">
            <div className="max-w-3xl">
              <h1 className="text-5xl font-bold mb-4">Benemérito Cuerpo de Bomberos Voluntarios zuldemaida</h1>
              <p className="text-xl mb-8 opacity-90">
                Dedicados a servir y proteger a nuestra comunidad con profesionalismo, valentía y compromiso. abnegacion valor disiplina
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/contact">
                  <a>
                    <Button size="lg" variant="outline" className="text-white border-white hover:bg-white/10">Contactar</Button>
                  </a>
                </Link>
              </div>
            </div>
